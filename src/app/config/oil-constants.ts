...
export const TEMPLATE_PICTURES: string[] = [
    "./assets/oil/templatePictures/template1.png",
    "./assets/oil/templatePictures/template2.png",
    "./assets/oil/templatePictures/template3.png",
    "./assets/oil/templatePictures/template4.png",
    "./assets/oil/templatePictures/template5.png",
    "./assets/oil/templatePictures/template6.png"
];

export const NO_PICTURE: string[] = [
    "./assets/oil/templatePictures/template0.png"
];
